...
class Server:
	...
	def evaluate_hit_miss(self,player):
		if player=="1":
			if self.player2_matrix[self.player1_x][self.player1_y]>0:
				...
				if (direction==1):
					for i in range(y,y+key):
						if self.player2_matrix[x][i]==-key:
							count+=1
					if count ==key:
						self.player1.send(str('uhit')+","+str(self.player1_x)+","+str(self.player1_y)+","+str(self.player1_score)+","+str(self.player2_score)+","+str(key))
						self.player2.send(str('hit')+","+str(self.player1_x)+","+str(self.player1_y)+","+str(self.player2_score)+","+str(self.player1_score)+","+str(key))
					else:
						self.player1.send(str('uhit')+","+str(self.player1_x)+","+str(self.player1_y)+","+str(self.player1_score)+","+str(self.player2_score)+","+str(0))
						self.player2.send(str('hit')+","+str(self.player1_x)+","+str(self.player1_y)+","+str(self.player2_score)+","+str(self.player1_score)+","+str(0))
				else:
				...
				self.player1.send(str('umiss')+","+str(self.player1_x)+","+str(self.player1_y)+","+str(self.player1_score)+","+str(self.player2_score))
				self.player2.send(str('miss')+","+str(self.player1_x)+","+str(self.player1_y)+","+str(self.player2_score)+","+str(self.player1_score))
				return "miss"
		if player=="2":
				...
				if (direction==1):
					for i in range(y,y+key):
						if self.player1_matrix[x][i]==-key:
							count+=1
					if count ==key:
						self.player2.send(str('uhit')+","+str(self.player2_x)+","+str(self.player2_y)+","+str(self.player2_score)+","+str(self.player1_score)+","+str(key))
						self.player1.send(str('hit')+","+str(self.player2_x)+","+str(self.player2_y)+","+str(self.player1_score)+","+str(self.player2_score)+","+str(key))
					else:
						self.player2.send(str('uhit')+","+str(self.player2_x)+","+str(self.player2_y)+","+str(self.player2_score)+","+str(self.player1_score)+","+str(0))
						self.player1.send(str('hit')+","+str(self.player2_x)+","+str(self.player2_y)+","+str(self.player1_score)+","+str(self.player2_score)+","+str(0))
				else:
					for i in range(x,x+key):
					...
					if count ==key:
						...
						self.player1.send(str('hit')+","+str(self.player2_x)+","+str(self.player2_y)+","+str(self.player1_score)+","+str(self.player2_score)+","+str(0))
				return "hit"
			elif self.player1_matrix[self.player2_x][self.player2_y]==0:
				self.player2.send(str('umiss')+","+str(self.player2_x)+","+str(self.player2_y)+","+str(self.player2_score)+","+str(self.player1_score))
				self.player1.send(str('miss')+","+str(self.player2_x)+","+str(self.player2_y)+","+str(self.player1_score)+","+str(self.player2_score))
				return "miss"
	...
	def player1_chance(self):
		...
		print (self.player1_attack)
		self.player1_coord=self.player1_attack.split(",")
		self.player1_x=int(self.player1_coord[0])
		self.player1_y=int(self.player1_coord[1])
	...
	def player2_chance(self):
		...
		self.player2_x=int(self.player2_coord[0])
		self.player2_y=int(self.player2_coord[1])
